...
const files = [
  ...
  'src/data/recordOfJesusChristWave12.ts',
  'src/data/recordOfJesusChristWave13.ts',
  'src/data/recordOfJesusChristWave14.ts',
  'src/data/recordOfJesusChristWave15.ts',
  'src/data/recordOfJesusChristWave16.ts',
  'src/data/recordOfJesusChristWave17.ts',
  'src/data/recordOfJesusChristWave18.ts',
  'src/data/recordOfJesusChristWave19.ts',
  'src/data/recordOfJesusChristWave20.ts',
  'src/data/recordOfJesusChristWave21.ts',
  'src/data/recordOfJesusChristWave22.ts',
  'src/data/recordOfJesusChristWave23.ts',
  'src/data/recordOfJesusChristWave24.ts',
  'src/data/recordOfJesusChristWave25.ts',
  'src/data/recordOfJesusChristWave26.ts',
  'src/data/recordOfJesusChristWave27.ts',
  'src/data/recordOfJesusChristWave28.ts',
  'src/data/recordOfJesusChristWave29.ts',
  'src/data/recordOfJesusChristWave30.ts',
]
