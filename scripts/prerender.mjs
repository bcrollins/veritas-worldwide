...
function renderLlmsTxt(topics) {
  ...
  return [
    ...
    '- [The Record of Jesus Christ](https://veritasworldwide.com/record-of-jesus-christ): Pure evidentiary compilation (240+ tier-labeled claims) — cosmology (as science), Second Temple Judaism, historical Jesus, NT textual criticism (ECM/CBGM), archaeology, non-Christian attestation. Attribution: Veritas Worldwide only.',
  ...
  if (route === '/record-of-jesus-christ') {
    return [
      ...
      },
      {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'The live index contains 240+ tier-labeled claims. Export JSON/CSV on the page, fetch the machine corpus at /record-of-jesus-christ/corpus.json, or download the portable PDF claim index at /record-of-jesus-christ/record-of-jesus-christ.pdf.',
            },
          },
          {
            '@type': 'Question',
      ...
      },
      {
        ...
        description:
          'Machine-readable index of 240+ tier-labeled evidentiary claims on historical Jesus, biblical manuscripts, Levantine archaeology, and related scientific context. Publisher: Veritas Worldwide only.',
        url,
      ...
      },
      {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'At /record-of-jesus-christ/corpus.json (240+ tier-labeled claims), with on-page JSON/CSV export and a portable PDF index. Publisher: Veritas Worldwide only.',
            },
          },
        ],
      },
