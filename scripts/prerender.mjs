...
function renderLlmsTxt(topics) {
  ...
  return [
    ...
    '- [Israel Dossier briefing source archive manifest](https://veritasworldwide.com/israel-dossier/workbooks/briefing-source-archive-manifest.json): 63+ pinned Wayback snapshots for briefing and primary-source durability when hosts block automated probes.',
