...
function renderLlmsTxt(topics) {
  ...
  return [
    ...
    '- [Israel Dossier briefing source archive manifest](https://veritasworldwide.com/israel-dossier/workbooks/briefing-source-archive-manifest.json): Pinned Wayback snapshots for public briefing source rows so evidence remains inspectable when hosts block automated probes.',
