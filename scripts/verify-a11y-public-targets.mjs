...
const floors = [
  ...
  { path: 'src/components/AuthModal.tsx', min: 5, label: 'auth modal' },
  { path: 'src/components/CookieConsent.tsx', min: 3, label: 'cookie consent' },
  ...
  { path: 'src/pages/AnalyticsPage.tsx', min: 2, label: 'analytics refresh' },
  { path: 'src/pages/TermsPage.tsx', min: 7, label: 'terms sidebar' },
  ...
  { path: 'src/components/institute/InstituteLayout.tsx', min: 9, label: 'institute footer nav' },
  { path: 'src/pages/SubscribeSuccessPage.tsx', min: 3, label: 'subscribe success CTAs' },
  { path: 'src/components/AipacDiagram.tsx', min: 7, label: 'AIPAC map controls' },
  { path: 'src/pages/BernieShowPage.tsx', min: 5, label: 'Bernie show controls' },
  { path: 'src/pages/ContentPackPage.tsx', min: 10, label: 'content pack downloads' },
