...
assert(tierHits >= 170, `expected ≥170 tiered claims across base+waves, got ${tierHits}`)
...
assert(corpus.claimCount >= 180, `corpus claimCount should include wave9 (≥180), got ${corpus.claimCount}`)
