...
assert(tierHits >= 180, `expected ≥180 tiered claims across base+waves, got ${tierHits}`)
...
assert(corpus.claimCount >= 189, `corpus claimCount should include wave10 (≥189), got ${corpus.claimCount}`)
