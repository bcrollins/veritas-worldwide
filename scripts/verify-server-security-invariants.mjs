...
assert(pureScriptCount >= 13, 'verify:pure must list at least 13 pure scripts')
assert(pureScriptCount === 13, `verify:pure must stay at exactly 13 pure scripts (got ${pureScriptCount})`)
