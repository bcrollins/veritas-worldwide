...
assert(pureScriptCount >= 11, 'verify:pure must list at least 11 pure scripts')
assert(pureScriptCount === 11, `verify:pure must stay at exactly 11 pure scripts (got ${pureScriptCount})`)
assert(
