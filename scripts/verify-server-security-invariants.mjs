...
assert(pureScriptCount >= 12, 'verify:pure must list at least 12 pure scripts')
assert(pureScriptCount === 12, `verify:pure must stay at exactly 12 pure scripts (got ${pureScriptCount})`)
assert(
