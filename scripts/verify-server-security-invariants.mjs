...
assert(pureScriptCount >= 19, 'verify:pure must list at least 19 pure scripts')
assert(pureScriptCount === 19, `verify:pure must stay at exactly 19 pure scripts (got ${pureScriptCount})`)
