...
assert(pureScriptCount >= 14, 'verify:pure must list at least 14 pure scripts')
assert(pureScriptCount === 14, `verify:pure must stay at exactly 14 pure scripts (got ${pureScriptCount})`)
