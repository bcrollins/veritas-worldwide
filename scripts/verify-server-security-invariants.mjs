...
assert(pureScriptCount >= 17, 'verify:pure must list at least 17 pure scripts')
assert(pureScriptCount === 17, `verify:pure must stay at exactly 17 pure scripts (got ${pureScriptCount})`)
