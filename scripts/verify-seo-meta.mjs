...
assert(
  topicHubs.includes('420+ tier-labeled') ||
    topicHubs.includes('420+ tier-labeled') ||
    topicHubs.includes('420+ tier-labeled'),
...
assert(homePage.includes('420+ tier-labeled') || homePage.includes('420+ tier-labeled'), 'Home must advertise current ROC claim floor')
...
assert(sourcesPage.includes('420+ tier-labeled') || sourcesPage.includes('420+ tier-labeled'), 'Sources must advertise current ROC claim floor')
...
assert(methodPage.includes('420+ claims') || methodPage.includes('420+ claims'), 'Methodology must advertise current ROC claim floor')
