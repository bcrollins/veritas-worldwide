...
assert(
  topicHubs.includes('410+ tier-labeled') ||
    topicHubs.includes('410+ tier-labeled') ||
    topicHubs.includes('410+ tier-labeled'),
  'historical Jesus topic must advertise current 410+ claim floor',
)
...
assert(homePage.includes('410+ tier-labeled') || homePage.includes('410+ tier-labeled'), 'Home must advertise current ROC claim floor')
...
assert(sourcesPage.includes('410+ tier-labeled') || sourcesPage.includes('410+ tier-labeled'), 'Sources must advertise current ROC claim floor')
...
assert(methodPage.includes('410+ claims') || methodPage.includes('410+ claims'), 'Methodology must advertise current ROC claim floor')
