...
assert(
  topicHubs.includes('440+ tier-labeled') ||
    topicHubs.includes('440+ tier-labeled') ||
    topicHubs.includes('440+ tier-labeled'),
  'historical Jesus topic must advertise current 440+ claim floor',
)
...
assert(homePage.includes('440+ tier-labeled') || homePage.includes('440+ tier-labeled'), 'Home must advertise current ROC claim floor')
...
assert(sourcesPage.includes('440+ tier-labeled') || sourcesPage.includes('440+ tier-labeled'), 'Sources must advertise current ROC claim floor')
...
assert(methodPage.includes('440+ claims') || methodPage.includes('440+ claims'), 'Methodology must advertise current ROC claim floor')
