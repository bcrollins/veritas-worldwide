...
assert(
  topicHubs.includes('430+ tier-labeled') ||
    topicHubs.includes('430+ tier-labeled') ||
    topicHubs.includes('430+ tier-labeled'),
  'historical Jesus topic must advertise current 430+ claim floor',
)
...
assert(homePage.includes('430+ tier-labeled') || homePage.includes('430+ tier-labeled'), 'Home must advertise current ROC claim floor')
...
assert(sourcesPage.includes('430+ tier-labeled') || sourcesPage.includes('430+ tier-labeled'), 'Sources must advertise current ROC claim floor')
...
assert(methodPage.includes('430+ claims') || methodPage.includes('430+ claims'), 'Methodology must advertise current ROC claim floor')
