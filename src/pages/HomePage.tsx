                ...
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                  <div className="min-w-0">
                    ...
                    <p className="font-body text-sm text-ink-muted leading-relaxed max-w-3xl">
                      670+ tier-labeled claims: cosmology as science, Second Temple sources, historical Jesus criteria, Nestle-Aland/ECM manuscript evidence, Levantine archaeology, and non-Christian attestation. JSON/CSV/PDF export. No advocacy. Entity attribution only.
                    </p>
                  </div>
