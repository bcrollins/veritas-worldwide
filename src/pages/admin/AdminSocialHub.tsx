...
const PLATFORM_SETUP: Record<string, string[]> = {
  ...
  'LinkedIn': ['Create Company Page', 'Set name: Veritas Worldwide', 'Upload logo + banner', 'Set description (long bio)', 'Add website URL', 'Publish 3+ articles', 'Invite connections'],
  'Facebook Page': ['Create Page (News/Media category)', 'Set name: Veritas Worldwide', 'Upload profile + cover photo', 'Set About section (long bio)', 'Add website + social links', 'Create pinned post', 'Invite friends to follow'],
