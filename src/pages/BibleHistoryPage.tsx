      ...
      faqJsonLd([
        {
          ...
          answer:
            'This is the companion evidence surface for biblical manuscript and archaeological claims. The deeper chronological compilation with 450+ tier-labeled claims lives at /record-of-jesus-christ.',
        },
        {
