      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14">
        <div className="lg:grid lg:grid-cols-[1fr_300px] lg:gap-12">
          ...
          <article className="max-w-none">
            ...
            {/* Editorial Team */}
            <section className="mb-12">
              <h2 className="text-2xl font-serif font-semibold text-foreground mb-6">Editorial Team</h2>
            ...
            {/* Editorial Standards */}
            <section className="mb-12">
              <h2 className="text-2xl font-serif font-semibold text-foreground mb-4">Editorial Standards</h2>
              <div className="bg-surface border border-border rounded-lg p-6 space-y-4 text-sm text-muted">
                <div className="flex gap-3">
                  <span className="w-5 h-5 rounded-full bg-[#166534] shrink-0 mt-0.5" />
                  <div>
                    <h4 className="font-semibold text-foreground mb-1">Source Verification</h4>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground mb-1">Evidence Tiering</h4>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground mb-1">Corrections Policy</h4>
            ...
            <section className="mb-12">
              ...
              <div className="bg-surface border border-border rounded-lg p-6">
                <a href="mailto:tips@veritasworldwide.com" className="text-accent hover:underline font-medium">
            ...
            {/* Subscribe CTA */}
            <section className="bg-foreground text-background rounded-xl p-8 md:p-10">
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-24 space-y-8">
              ...
              <div className="bg-surface border border-border rounded-lg p-5">
                <h3 className="text-sm font-semibold text-foreground uppercase tracking-wider mb-4">At a Glance</h3>
                <dl className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    <dt className="text-muted">Chapters</dt>
                    <dd className="font-medium text-foreground">31</dd>
                  </div>
                  <div className="flex justify-between">
                    <dt className="text-muted">Power Profiles</dt>
                    <dd className="font-medium text-foreground">91+</dd>
                  </div>
                  <div className="flex justify-between">
                    <dt className="text-muted">Primary Sources</dt>
                    <dd className="font-medium text-foreground">500+</dd>
                  </div>
                  <div className="flex justify-between">
              ...
              {/* Evidence Tiers */}
              <div className="bg-surface border border-border rounded-lg p-5">
                <h3 className="text-sm font-semibold text-foreground uppercase tracking-wider mb-4">Evidence Tiers</h3>
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-foreground">Circumstantial</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="w-3 h-3 rounded-full bg-[#991B1B]" />
                    <span className="text-sm text-foreground">Disputed</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-surface border border-border rounded-lg p-5">
                ...
                <nav className="space-y-2">
                  ...
                  <Link to="/terms" className="block text-sm text-muted hover:text-accent transition-colors">
                    → Terms of Use
                  </Link>
                </nav>
              </div>
