    ...
    setJsonLd([
      ...
      faqJsonLd([
        ...
        },
        {
          ...
          answer:
            'At /record-of-jesus-christ — 200+ claims with proofVsConcept hygiene, primary/peer sources, JSON/CSV/PDF export, and entity-only attribution (Veritas Worldwide).',
        },
        {
