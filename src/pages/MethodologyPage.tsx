...
export default function MethodologyPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12 md:py-16">
      ...
      {/* Support CTA */}
      <section className="border-t border-border pt-10 mb-12 text-center">
        <p className="font-sans text-[0.6rem] font-bold tracking-[0.2em] uppercase text-ink-faint mb-3">
          Free &amp; Open Access
        </p>
        <p className="font-body text-sm text-ink-muted leading-relaxed max-w-lg mx-auto mb-5">
          Maintaining rigorous editorial standards takes time and resources. Every chapter of The Record is free because we believe the public record belongs to everyone. If you value this standard of evidence, a small contribution helps us continue.
        </p>
        <a
