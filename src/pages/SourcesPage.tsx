    ...
    setJsonLd([
      ...
      faqJsonLd([
        ...
        },
        {
          ...
          answer:
            'At /record-of-jesus-christ/corpus.json (450+ claims), with on-page JSON/CSV export and a portable PDF index. Publisher: Veritas Worldwide only.',
        },
      ]),
    ])
    return () => {
            ...
            <header className="mb-12 border-b border-border pb-10">
              ...
              <div className="mt-6 rounded-sm border border-border bg-surface p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <p className="font-body text-sm text-ink-muted max-w-2xl">
                  Looking for the historical Jesus / manuscript claim corpus? Open the 450+ tier-labeled Record of Jesus Christ with JSON, CSV, and PDF export.
                </p>
