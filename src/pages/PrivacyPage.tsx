        ...
        <div className="lg:grid lg:grid-cols-[1fr_300px] lg:gap-12">
          ...
          <article className="max-w-none">
            ...
            <section id="usage" className="mb-10">
              <h2 className="text-xl font-serif font-semibold text-foreground mb-3">How We Use Your Information</h2>
              <div className="space-y-3 text-sm text-muted leading-relaxed">
            ...
            <section id="third-party" className="mb-10">
              ...
              <div className="space-y-3 text-sm text-muted leading-relaxed">
                ...
                <ul className="list-disc list-inside space-y-1 ml-2">
                  ...
                  <li><strong className="text-foreground">Google Analytics 4</strong> — Site usage analytics</li>
                  <li><strong className="text-foreground">HubSpot</strong> — CRM and email communications</li>
                  <li><strong className="text-foreground">Railway</strong> — Application hosting</li>
                </ul>
            ...
            <section id="cookies" className="mb-10">
              <h2 className="text-xl font-serif font-semibold text-foreground mb-3">Cookies & Tracking</h2>
              <div className="space-y-3 text-sm text-muted leading-relaxed">
            ...
            <section id="contact" className="mb-10">
              <h2 className="text-xl font-serif font-semibold text-foreground mb-3">Contact Us</h2>
              <p className="text-sm text-muted leading-relaxed">
                For privacy-related questions or requests, contact us at{' '}
                <a href="mailto:privacy@veritasworldwide.com" className="text-accent hover:underline">privacy@veritasworldwide.com</a>.
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-24 space-y-8">
              ...
              <div className="bg-accent/5 border border-accent/20 rounded-lg p-5">
                <h3 className="text-sm font-semibold text-foreground mb-2">Your Privacy Matters</h3>
                <p className="text-xs text-muted">We believe investigative journalism and data privacy go hand in hand. No ads, no data sales, ever.</p>
              </div>
            </div>
          </aside>
        </div>
