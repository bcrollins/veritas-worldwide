...
const PACKS: ContentPack[] = [
  ...
  },
  {
    ...
    platforms: {
      ...
      facebook: 'The Department of Justice has released 3.5 million pages of Jeffrey Epstein files \u2014 the largest document disclosure in DOJ history.\n\nVeritas Worldwide Press breaks down every primary source: the Congressional authorization, the DOJ compliance filing, the UN OHCHR statement on victim privacy, and what these documents actually contain.\n\nRead the full analysis:',
  ...
  },
  {
    ...
    platforms: {
      ...
      facebook: 'The proposed FY2027 defense budget totals $1.5 trillion when you include the $152 billion reconciliation supplement.\n\nThat\u2019s $4,500 for every man, woman, and child in America.\n\nVeritas Worldwide Press has broken down the full budget with primary sources: Senate Appropriations Committee data, Congressional Research Service analysis, and Defense Department filings.\n\nRead the breakdown:',
  ...
  },
  {
    ...
    body: 'Veritas Worldwide Press cites exclusively primary sources: government documents, court filings, congressional records. No anonymous sources. No opinion. No spin. We document the public record and leave conclusions to you.',
    ...
    platforms: {
      twitter: 'We don\u2019t tell you what to think.\n\nVeritas Worldwide Press cites exclusively primary sources: government documents, court filings, congressional records.\n\nNo anonymous sources. No opinion. No spin.\n\n500+ sources. 31 chapters. 100% free.',
      facebook: 'We don\u2019t tell you what to think.\n\nVeritas Worldwide Press is a documentary publication that cites exclusively primary sources: government documents, court filings, congressional records, and declassified intelligence reports.\n\nNo anonymous sources. No editorial opinion. No narrative framing.\n\n31 chapters. 500+ primary sources. Three-tier evidence classification. 100% free and open access.\n\nRead the record for yourself:',
        ...
        <section className="mt-16 bg-surface border border-border rounded-lg p-8">
          ...
          <div className="grid sm:grid-cols-2 gap-6 font-body text-sm text-ink-muted leading-relaxed">
            <div>
              ...
              <p>Share any content pack on any platform. Download and use any graphic. Modify post text to fit your audience. Link to any article or chapter. Use our logo in press coverage or social posts that reference Veritas Worldwide Press.</p>
            </div>
            <div>
              <h3 className="font-sans text-[0.65rem] font-bold tracking-[0.15em] uppercase text-ink-faint mb-2">Please Do Not</h3>
              <p>Alter the meaning of quoted statistics or claims. Remove attribution to Veritas Worldwide Press. Use our brand to imply endorsement of products, candidates, or organizations. Misrepresent our editorial stance — we present evidence, not opinion.</p>
            </div>
          </div>
        </section>
      </div>
