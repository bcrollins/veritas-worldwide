...
export const instituteFieldManualEntries: InstituteFieldManualEntry[] = [
  {
    ...
    urgency: 'High',
    timeWindow: 'Before anyone eats; immediately if symptoms begin.',
    decisionRule: 'No whole-plant, region-specific positive identification means no eating.',
    ...
    gear: ['Phone camera', 'Regional field guide', 'Poison Control contact'],
    doNow: [
    ...
    escalateIf: [
      'A child, older adult, or pet ate an unknown plant.',
      'Vomiting, trouble breathing, seizure, collapse, confusion, or severe pain appears.',
      'You cannot identify the plant with certainty after ingestion.',
    ],
  ...
  },
  {
    ...
    urgency: 'High',
    timeWindow: 'Before the first cable connection.',
    decisionRule: 'Only use equipment rated for vehicle starting and the vehicle battery system in front of you.',
    ...
    gear: ['Rated jumper cables or jump pack', 'Eye protection', 'Owner manual'],
    doNow: [
    ...
    escalateIf: [
      'The battery is cracked, leaking, swollen, frozen, hissing, or hot.',
      'Cables heat, spark aggressively, smoke, or cannot clamp securely.',
      'The vehicle is hybrid, electric, or has manufacturer jump-start steps you cannot verify.',
    ],
  ...
  },
  {
    ...
    urgency: 'Immediate',
    timeWindow: 'First 0-5 minutes.',
    decisionRule: 'Call 911, put firm pressure on the source, and use wound packing or a tourniquet only as trained and anatomically appropriate.',
    ...
    gear: ['Gloves or hand barrier', 'Gauze or clean cloth', 'Commercial tourniquet'],
    doNow: [
    ...
    escalateIf: [
      'Blood spurts, pools, or soaks clothing or dressings quickly.',
      'The person becomes pale, confused, cold, dizzy, or less responsive.',
      'The scene is unsafe, the wound is deep, or an object is embedded.',
    ],
  ...
  },
  {
    ...
    urgency: 'Immediate',
    timeWindow: 'First 2-10 minutes.',
    decisionRule: 'Stop flow first, relieve pressure second, document damage third.',
    ...
    gear: ['Flashlight', 'Valve key or adjustable wrench', 'Towels, mop, or wet vacuum'],
    doNow: [
    ...
    escalateIf: [
      'Water reaches electrical devices, outlets, panels, ceilings, or insulation.',
      'The main valve does not stop flow.',
      'Structural materials stay wet or sewage is involved.',
    ],
  ...
  },
  {
    ...
    urgency: 'High',
    timeWindow: 'Before drinking, cooking, brushing teeth, washing food, or making ice.',
    decisionRule: 'Germs can often be handled with boiling or approved treatment; fuel, chemicals, and radioactive material require another water source.',
    ...
    gear: ['Clean containers', 'Pot or kettle', 'Filter cloth, EPA/CDC treatment method, or bottled water'],
    doNow: [
    ...
    escalateIf: [
      'Water smells like fuel, chemicals, sewage, or has an unusual color or oily sheen.',
      'A local health department gives instructions that differ from generic guidance.',
      'Infants, immunocompromised people, or medical equipment depend on the water.',
    ],
  ...
  },
  {
    ...
    urgency: 'Immediate',
    timeWindow: 'At the first smell, hiss, alarm, or suspected leak.',
    decisionRule: 'Evacuate before troubleshooting; calls happen from outside the structure.',
    ...
    gear: ['Utility emergency number', 'Outdoor phone', 'Household meeting point'],
    doNow: [
    ...
    escalateIf: [
      'Anyone feels dizzy, nauseated, weak, or short of breath.',
      'You hear a hiss, see damaged gas equipment, or smell gas indoors.',
      'An ignition source, fire, explosion, or blocked exit is present.',
    ],
  ...
  },
  {
    ...
    urgency: 'Moderate',
    timeWindow: 'First 4 refrigerator hours; freezer check when power returns.',
    decisionRule: 'Temperature records beat smell, taste, appearance, and hope.',
    ...
    gear: ['Appliance thermometer', 'Cooler', 'Ice or frozen gel packs'],
    doNow: [
    ...
    escalateIf: [
      'Perishable food has been above 40°F for two hours or more.',
      'Floodwater touched food, containers, utensils, or food-contact surfaces.',
      'Someone in the household is pregnant, immunocompromised, elderly, or very young.',
    ],
  ...
  },
  {
    ...
    urgency: 'High',
    timeWindow: 'Before lighting, plugging in, or refueling any backup heat or cooking device.',
    decisionRule: 'Outdoor combustion stays outdoors; indoor-rated combustion still needs ventilation, clearance, and working carbon monoxide alarms.',
    ...
    gear: ['Carbon monoxide alarm', 'Manufacturer manual', 'Outdoor-rated cord or approved indoor fuel only'],
    doNow: [
    ...
    escalateIf: [
      'A carbon monoxide alarm sounds or anyone develops headache, dizziness, weakness, nausea, or confusion.',
      'The only available heat source is outdoor-only.',
      'Fuel storage, cords, or ventilation cannot be made safe.',
    ],
  ...
  },
  {
    ...
    urgency: 'High',
    timeWindow: 'Interior control now; exterior tarp only during a safe weather window.',
    decisionRule: 'Interior damage control beats unsafe roof access.',
    ...
    gear: ['Buckets and plastic sheeting', 'Camera', 'Tarp, rope, and ladder only if conditions are safe'],
    doNow: [
    ...
    escalateIf: [
      'Water is near electrical devices, recessed lights, wiring, or the service panel.',
      'Ceiling material sags, cracks, or smells musty.',
      'Wind, lightning, roof pitch, ice, or ladder setup makes exterior access unsafe.',
    ],
  ...
  },
  {
    ...
    urgency: 'High',
    timeWindow: 'Before the first overflow, backup, or mixed-use water container.',
    decisionRule: 'Separate clean water, gray water, and waste immediately.',
    ...
    gear: ['Soap or sanitizer', 'Heavy bags and labels', 'Disinfectant matched to label directions'],
    doNow: [
    ...
    escalateIf: [
      'Sewage backs up into living areas.',
      'Waste contacts food, drinking-water containers, or medical supplies.',
      'A child, elderly person, or immunocompromised person may have been exposed.',
    ],
  ...
  },
  {
    ...
    urgency: 'Moderate',
    timeWindow: 'At outage start, before the phone falls below 50 percent.',
    decisionRule: 'Preserve battery for alerts, text, navigation, and emergency calls before comfort use.',
    ...
    gear: ['Charged power bank', 'Vehicle charger', 'Written contact plan'],
    doNow: [
    ...
    escalateIf: [
      'Emergency alerts, evacuation orders, or medical check-ins depend on the device.',
      'A family member is separated and there is no agreed check-in window.',
      'Cell service is failing and you have a NOAA/weather radio or local broadcast option available.',
    ],
  ...
  },
  {
    ...
    urgency: 'Immediate',
    timeWindow: 'First 10 minutes, then hourly until help or safe movement.',
    decisionRule: 'Stay with the vehicle unless shelter is plainly visible and close; manage carbon monoxide and visibility first.',
    ...
    gear: ['Winter vehicle kit', 'Reflective marker or hazard lights', 'Blankets and water'],
    doNow: [
    ...
    escalateIf: [
      'Exhaust cannot stay clear, fuel is critically low, or carbon monoxide symptoms appear.',
      'A person is wet, shivering uncontrollably, confused, or unusually drowsy.',
      'The vehicle is in an active traffic lane or another immediate hazard zone.',
    ],
  ...
  {
    id: 'generator-carbon-monoxide',
    category: 'Outage Power',
    title: 'Run a generator without poisoning the house',
    summary: 'Portable generators solve one problem and create another if exhaust drifts into the home. Carbon monoxide has no useful warning smell.',
    whenToUse: 'You are using or considering a generator, fuel-powered tool, grill, camp stove, or backup power source during an outage.',
    urgency: 'Immediate',
    timeWindow: 'Before startup and after every placement change.',
    decisionRule: 'Fuel-burning backup power stays outdoors, at least 20 feet from doors, windows, vents, and attached garages.',
    quickAnswer: 'Place the generator outside with exhaust pointed away from the structure, use outdoor-rated cords, keep it dry, and run working carbon monoxide alarms inside.',
    gear: ['Carbon monoxide alarms', 'Outdoor-rated extension cords', 'Generator manual and fuel plan'],
    doNow: [
      'Measure or pace the generator away from doors, windows, vents, and attached garages before starting it.',
      'Point exhaust away from the house and any neighboring openings.',
      'Use heavy-duty outdoor-rated cords and plug only the loads you have intentionally prioritized.',
    ],
    avoid: [
      'Do not run a generator in a garage, carport, basement, porch, shed, or near an open window.',
      'Do not backfeed a house panel without a transfer switch installed by a qualified electrician.',
      'Do not refuel a hot running generator.',
    ],
    escalateIf: [
      'A carbon monoxide alarm sounds or anyone has headache, dizziness, weakness, nausea, confusion, or chest pain.',
      'Weather, theft risk, or cord length prevents safe outdoor placement.',
      'You need to power medical equipment and cannot maintain safe generator operation.',
    ],
    sourceAnchors: ['CDC carbon monoxide guidance', 'Ready.gov power outage guidance', 'Generator manual'],
    relatedTopicSlug: 'how-to-install-solar-backup-power-at-home',
  },
  {
    id: 'downed-power-line',
    category: 'Electrical Hazard',
    title: 'Stay alive around a downed power line',
    summary: 'A downed line can energize the ground around it. The danger is not just touching the wire; it is stepping through voltage difference.',
    whenToUse: 'A storm, crash, falling tree, or damaged pole leaves wires on the ground, on a vehicle, or near standing water.',
    urgency: 'Immediate',
    timeWindow: 'Until the utility confirms the line is de-energized.',
    decisionRule: 'Stay far away, keep others back, and let the utility or fire department control the scene.',
    quickAnswer: 'Assume every downed line is live. Stay back, avoid water and fences near it, call 911 or the utility, and shuffle away with feet together if you must move from an energized area.',
    gear: ['Phone', 'Flashlight or cones for distance marking', 'Utility emergency number'],
    doNow: [
      'Call 911 or the utility emergency line and give the exact location.',
      'Warn people to stay back from wires, puddles, fences, trees, and vehicles touching the line.',
      'If you must move away, keep feet close together and shuffle without taking large steps.',
    ],
    avoid: [
      'Do not touch the line with a tool, branch, vehicle, ladder, or rope.',
      'Do not drive over a downed line.',
      'Do not approach a person or vehicle touching the line until responders say it is safe.',
    ],
    escalateIf: [
      'A line is on a vehicle with people inside.',
      'Fire, smoke, arcing, water, gas smell, or structural damage is present.',
      'Bystanders cannot be kept away from the hazard zone.',
    ],
    sourceAnchors: ['Local electric utility', 'National Weather Service storm safety', 'Fire department instructions'],
    relatedTopicSlug: 'how-to-do-basic-home-electrical-troubleshooting-safely',
  },
  {
    id: 'home-fire-escape',
    category: 'Fire',
    title: 'Get out of a house fire in under two minutes',
    summary: 'Fire escape is a movement problem, not a belongings problem. The household needs two exits, a meeting point, and a rule against going back inside.',
    whenToUse: 'A smoke alarm sounds, smoke appears, a room is burning, or you are planning the household fire drill before an emergency.',
    urgency: 'Immediate',
    timeWindow: 'Under two minutes once the alarm or fire condition begins.',
    decisionRule: 'Get people out first, then call 911 from the meeting point.',
    quickAnswer: 'Move low under smoke, use the nearest safe exit, avoid hot doors, meet outside at the chosen spot, call 911, and do not re-enter.',
    gear: ['Working smoke alarms', 'Escape ladder for upper floors if needed', 'Written meeting point'],
    doNow: [
      'Move toward the safest exit while staying low if smoke is present.',
      'Check doors for heat before opening and use a second exit if the door or handle is hot.',
      'Meet at the planned outdoor spot and tell firefighters who may still be inside.',
    ],
    avoid: [
      'Do not search for valuables, pets, documents, or the source of the fire before leaving.',
      'Do not open a hot or smoke-leaking door.',
      'Do not go back inside once you are out.',
    ],
    escalateIf: [
      'A person cannot self-evacuate.',
      'Smoke blocks the exits.',
      'Burns, smoke inhalation, trapped occupants, or missing people are involved.',
    ],
    sourceAnchors: ['Ready.gov home fire escape plan', 'NFPA home fire safety', 'Local fire department'],
  },
  {
    id: 'grease-fire',
    category: 'Kitchen Fire',
    title: 'Stop a small pan fire without making it explode',
    summary: 'Grease fires punish panic. Water spreads burning oil; oxygen control and evacuation discipline matter more.',
    whenToUse: 'Oil, grease, or food ignites in a pan, oven, or cooktop area.',
    urgency: 'Immediate',
    timeWindow: 'First seconds, only while the fire is small and escape is clear.',
    decisionRule: 'If it is small and contained, smother it; if not, evacuate and call 911.',
    quickAnswer: 'Turn off heat if safe, slide a lid over a small pan fire, leave it covered, use a proper extinguisher only if trained, and evacuate if the fire grows.',
    gear: ['Fitted lid or baking sheet', 'Class B/K-rated extinguisher if trained', 'Clear exit path'],
    doNow: [
      'Turn off the burner if you can do it without reaching through flame.',
      'Slide a lid or baking sheet over the pan and leave it covered until completely cool.',
      'Evacuate and call 911 if the fire spreads, smoke thickens, or you are unsure.',
    ],
    avoid: [
      'Do not pour water on a grease fire.',
      'Do not carry a burning pan through the house.',
      'Do not uncover the pan early to check.',
    ],
    escalateIf: [
      'Flames leave the pan, reach cabinets, or enter the range hood.',
      'Smoke makes breathing or visibility difficult.',
      'The extinguisher is not the right class or you have no clear exit behind you.',
    ],
    sourceAnchors: ['NFPA cooking safety', 'Local fire department', 'Extinguisher label'],
    relatedTopicSlug: 'how-to-bake-bread-with-basic-pantry-supplies',
  },
  {
    id: 'heat-illness',
    category: 'Extreme Heat',
    title: 'Cool someone showing heat illness signs',
    summary: 'Heat illness moves from uncomfortable to life-threatening when confusion, collapse, or inability to cool appears.',
    whenToUse: 'Someone in hot weather is sweating heavily, nauseated, faint, confused, cramping, or no longer acting normally.',
    urgency: 'Immediate',
    timeWindow: 'First 0-10 minutes after symptoms are recognized.',
    decisionRule: 'Move, cool, hydrate if awake, and escalate fast for confusion, collapse, or worsening symptoms.',
    quickAnswer: 'Move the person to a cool place, remove excess layers, cool skin with wet cloths or water, give sips of water if awake, and call emergency services for severe or worsening signs.',
    gear: ['Water', 'Shade or air conditioning', 'Cool wet cloths or spray bottle'],
    doNow: [
      'Move the person out of heat and stop exertion immediately.',
      'Cool the body with wet cloths, water, fans, shade, or air conditioning.',
      'Offer small sips of water only if the person is awake and able to swallow safely.',
    ],
    avoid: [
      'Do not keep them working or walking to prove toughness.',
      'Do not give alcohol or force fluids into a confused or unconscious person.',
      'Do not wait for a thermometer before acting on severe symptoms.',
    ],
    escalateIf: [
      'Confusion, fainting, seizure, loss of consciousness, or very hot skin appears.',
      'Symptoms get worse after cooling begins.',
      'The person is elderly, very young, pregnant, medically fragile, or taking heat-risk medications.',
    ],
    sourceAnchors: ['CDC heat illness guidance', 'National Weather Service heat safety', 'Local emergency medical instructions'],
    relatedTopicSlug: 'how-to-stay-safe-in-extreme-weather',
  },
  {
    id: 'hypothermia-response',
    category: 'Cold Exposure',
    title: 'Handle hypothermia signs without shocking the person',
    summary: 'Cold exposure becomes dangerous when the person cannot think or move well. Rough handling and wrong warming sequence can make severe cases worse.',
    whenToUse: 'A person is cold, wet, confused, exhausted, slurring speech, fumbling, unusually drowsy, or has stopped shivering.',
    urgency: 'Immediate',
    timeWindow: 'First 0-10 minutes after recognition.',
    decisionRule: 'Shelter, dry, warm the core, and get medical help for confusion, temperature below 95°F, or severe symptoms.',
    quickAnswer: 'Move the person gently to shelter, remove wet clothing, warm the chest, neck, head, and groin, avoid alcohol, and get medical help quickly.',
    gear: ['Dry layers or blankets', 'Warm sweet drink only if awake', 'Thermometer if available'],
    doNow: [
      'Move the person out of wind, water, and cold ground.',
      'Remove wet clothing and wrap them in dry layers including head and neck.',
      'Warm the core first with blankets, body heat, or safe heat sources.',
    ],
    avoid: [
      'Do not rub limbs, use alcohol, or warm hands and feet first in severe cold exposure.',
      'Do not put an unconscious or confused person in a hot bath.',
      'Do not give drinks to someone who cannot swallow safely.',
    ],
    escalateIf: [
      'The person is confused, drowsy, has slurred speech, or has a temperature below 95°F.',
      'They are unconscious, not breathing normally, or have no obvious pulse.',
      'Cold exposure follows water immersion, injury, intoxication, or prolonged outdoor exposure.',
    ],
    sourceAnchors: ['CDC hypothermia guidance', 'National Weather Service winter safety', 'American Red Cross winter storm guidance'],
    relatedTopicSlug: 'how-to-stay-safe-in-extreme-weather',
  },
  {
    id: 'tornado-warning-shelter',
    category: 'Severe Weather',
    title: 'Shelter correctly during a tornado warning',
    summary: 'The safest available place is low, interior, and away from glass. The wrong move is staying in a vehicle, mobile home, or windowed room too long.',
    whenToUse: 'A tornado warning is issued, sirens sound, a tornado is visible, or severe rotating storm conditions approach.',
    urgency: 'Immediate',
    timeWindow: 'Immediately when warning arrives; do not wait for visual confirmation.',
    decisionRule: 'Lowest level, smallest interior space, protect the head, stay away from windows.',
    quickAnswer: 'Go to a basement or small interior room on the lowest floor, cover your head and body, keep shoes on, and stay there until warnings clear.',
    gear: ['Shoes', 'Weather radio or alerts', 'Helmet, pillow, mattress, or heavy blanket'],
    doNow: [
      'Move to the lowest available interior room, hallway, closet, or bathroom.',
      'Put walls between you and the outside and cover your head and neck.',
      'Bring shoes, phone, and critical medications if they are already nearby.',
    ],
    avoid: [
      'Do not shelter near windows, exterior doors, or large-span rooms.',
      'Do not stay in a mobile home if a stronger shelter is reachable in time.',
      'Do not try to photograph or watch the tornado from outside.',
    ],
    escalateIf: [
      'You are in a vehicle, mobile home, temporary structure, or large public building.',
      'A person has mobility limitations and needs immediate help moving to shelter.',
      'Debris impact, structural damage, gas smell, or injuries occur after the storm.',
    ],
    sourceAnchors: ['National Weather Service tornado safety', 'Ready.gov tornado guidance', 'Local emergency alerts'],
    relatedTopicSlug: 'how-to-stay-safe-in-extreme-weather',
  },
  {
    id: 'flash-flood-roadway',
    category: 'Flood',
    title: 'Do not drive through floodwater',
    summary: 'Flood depth is not visible from the driver seat, and the road may be gone underneath. Turning around is the action, not the slogan.',
    whenToUse: 'Water covers a road, bridge, underpass, low crossing, driveway, or evacuation route.',
    urgency: 'Immediate',
    timeWindow: 'Before the vehicle enters water.',
    decisionRule: 'Unknown water on a roadway means stop, turn around, and choose a different route.',
    quickAnswer: 'Never drive into floodwater. Turn around, move to higher ground when needed, obey barricades, and abandon the vehicle only if rising water makes staying more dangerous and escape is safe.',
    gear: ['Weather alerts', 'Alternate route', 'Phone and emergency contact plan'],
    doNow: [
      'Stop before the water and turn around without testing depth.',
      'Use official road closures, weather alerts, and local emergency instructions.',
      'If water rises around a stopped vehicle, leave for higher ground only when it is safe to do so.',
    ],
    avoid: [
      'Do not drive around barricades.',
      'Do not assume a familiar road is intact under water.',
      'Do not let darkness, urgency, or vehicle size persuade you to cross.',
    ],
    escalateIf: [
      'Water is rising around you or moving fast.',
      'Someone is trapped in a vehicle or swept into water.',
      'Evacuation routes are closing and official instructions are changing.',
    ],
    sourceAnchors: ['National Weather Service flood safety', 'Ready.gov flood guidance', 'State DOT road closures'],
    relatedTopicSlug: 'how-to-stay-safe-in-extreme-weather',
  },
  {
    id: 'medical-device-power',
    category: 'Medical Continuity',
    title: 'Keep power-dependent medical devices alive during an outage',
    summary: 'Medical power planning is not the same as convenience charging. The plan needs device priority, backup runtime, provider guidance, and a relocation threshold.',
    whenToUse: 'A household depends on oxygen, CPAP/BiPAP, refrigerated medication, powered mobility, dialysis support, hearing aids, or other medical equipment.',
    urgency: 'High',
    timeWindow: 'Before outage season and again at the first outage alert.',
    decisionRule: 'Know the runtime, backup source, and evacuation threshold before batteries are low.',
    quickAnswer: 'List each device, its power draw, backup runtime, charging method, and medical fallback; contact the provider or utility early when the backup window is shorter than the outage risk.',
    gear: ['Device manual', 'Backup battery or generator plan', 'Provider and utility contact list'],
    doNow: [
      'Write down each device, battery runtime, charger type, and required storage temperature.',
      'Charge backups early and protect refrigerated medication with thermometer-confirmed cold storage.',
      'Call the medical provider, utility medical needs program, or local emergency management before the backup window collapses.',
    ],
    avoid: [
      'Do not assume a consumer power bank can run medical equipment safely.',
      'Do not wait until the backup battery is nearly dead before relocating.',
      'Do not run fuel-powered backup power indoors or near openings.',
    ],
    escalateIf: [
      'Backup power will run out before utility restoration is likely.',
      'Medication temperature cannot be maintained.',
      'The person has breathing, mobility, dialysis, or life-support needs that cannot tolerate interruption.',
    ],
    sourceAnchors: ['CDC power sources guidance', 'Ready.gov power outage guidance', 'Device manufacturer instructions'],
    relatedTopicSlug: 'how-to-build-a-72-hour-emergency-kit',
  },
  {
    id: 'wet-electrical-panel',
    category: 'Electrical Cleanup',
    title: 'Handle wet electrical equipment after flooding or leaks',
    summary: 'Water and electricity turn cleanup into an electrocution problem. The first decision is whether you can safely stay away and call the right help.',
    whenToUse: 'Water contacts outlets, cords, appliances, a breaker panel, extension cords, or electrical equipment after a leak, flood, or storm.',
    urgency: 'Immediate',
    timeWindow: 'Before touching water, breakers, cords, or appliances.',
    decisionRule: 'If you are wet, standing in water, or near energized equipment, stay out and call for help.',
    quickAnswer: 'Do not enter standing water near electrical equipment. If safe from a dry location, shut power off at the main; otherwise call the utility, fire department, or electrician.',
    gear: ['Phone', 'Flashlight', 'Licensed electrician or utility contact'],
    doNow: [
      'Keep people away from wet electrical areas.',
      'Shut off power only from a dry, safe location that does not require stepping into water.',
      'Have wet outlets, panels, cords, and appliances inspected before reuse.',
    ],
    avoid: [
      'Do not touch breakers, plugs, cords, appliances, or water if you are wet or standing in water.',
      'Do not reuse flooded electrical equipment just because it turns on.',
      'Do not run extension cords through wet areas.',
    ],
    escalateIf: [
      'A breaker panel, outlet, appliance, or service entrance is wet.',
      'You smell burning, see arcing, hear buzzing, or lights flicker after water exposure.',
      'Floodwater, sewage, or storm damage is involved.',
    ],
    sourceAnchors: ['Local electric utility', 'CDC disaster cleanup guidance', 'Licensed electrician'],
    relatedTopicSlug: 'how-to-do-basic-home-electrical-troubleshooting-safely',
  },
  {
    id: 'emergency-medication-bag',
    category: 'Evacuation',
    title: 'Build a medication and documents grab bag',
    summary: 'Evacuations fail in small details: prescriptions, IDs, insurance cards, chargers, and medical instructions scattered across the house.',
    whenToUse: 'Storms, fires, evacuations, hospital trips, travel disruption, or any household that depends on daily medication or medical records.',
    urgency: 'Moderate',
    timeWindow: 'Before an evacuation order; refresh monthly.',
    decisionRule: 'The bag should let the household leave in minutes without losing medical continuity or identity documents.',
    quickAnswer: 'Keep copies of IDs, insurance cards, medication lists, allergies, provider contacts, chargers, and a rotation plan for essential medicines in one reachable bag.',
    gear: ['Waterproof document pouch', 'Medication list', 'Chargers and backup battery'],
    doNow: [
      'Photograph and copy IDs, insurance cards, prescriptions, and critical documents.',
      'Write one medication list with dose, schedule, prescribing provider, pharmacy, and allergy notes.',
      'Use a monthly calendar reminder to rotate anything that expires or changes.',
    ],
    avoid: [
      'Do not store the only copy of critical documents in the bag.',
      'Do not let medication lists drift after prescription changes.',
      'Do not bury the bag where it cannot be reached quickly.',
    ],
    escalateIf: [
      'A medication requires refrigeration, injection supplies, oxygen, or powered equipment.',
      'A person cannot explain their own medical needs during stress.',
      'Evacuation may separate caregivers from dependents.',
    ],
    sourceAnchors: ['Ready.gov emergency kit guidance', 'CDC power sources guidance', 'Provider medication instructions'],
    relatedTopicSlug: 'how-to-build-a-72-hour-emergency-kit',
  },
  {
    id: 'boil-water-advisory',
    category: 'Water',
    title: 'Use a boil-water advisory without guessing',
    summary: 'A boil-water advisory changes ordinary tasks: drinking, brushing teeth, baby formula, ice, dishwashing, and food prep all need the same rule set.',
    whenToUse: 'A utility, health department, school, campground, or local authority issues a boil-water notice or says water may be unsafe.',
    urgency: 'High',
    timeWindow: 'Immediately after advisory, until the all-clear is issued.',
    decisionRule: 'Use bottled, boiled, or properly treated water for anything that can enter the body.',
    quickAnswer: 'Use bottled water if available. Otherwise bring clear water to a rolling boil for 1 minute, or 3 minutes above 6,500 feet, then cool and store in clean containers.',
    gear: ['Clean pot', 'Clean covered containers', 'Bottled water or approved treatment method'],
    doNow: [
      'Use safe water for drinking, cooking, brushing teeth, washing food, baby formula, handwashing when required, and making ice.',
      'Filter cloudy water through clean cloth before boiling or treating.',
      'Follow local health department instructions for start time, affected area, and all-clear.',
    ],
    avoid: [
      'Do not use unsafe tap water for ice, baby formula, brushing teeth, or rinsing ready-to-eat food.',
      'Do not assume a filter pitcher replaces boiling or official treatment guidance.',
      'Do not store boiled water in dirty containers.',
    ],
    escalateIf: [
      'Water may contain fuel, chemicals, sewage, or flood contamination.',
      'An infant, immunocompromised person, or medical device depends on the water.',
      'You cannot boil, treat, or obtain safe water before the household needs it.',
    ],
    sourceAnchors: ['CDC emergency water guidance', 'EPA emergency disinfection guidance', 'Local health department'],
    relatedTopicSlug: 'how-to-purify-water-in-an-emergency',
  },
  {
    id: 'smoke-alarm-night-check',
    category: 'Fire',
    title: 'Make smoke alarms a sleep-safety system',
    summary: 'Smoke alarms are not decor. They are the system that wakes people up when sight and smell are late.',
    whenToUse: 'You are setting up a home, rental, short-term stay, child-care routine, or seasonal safety reset.',
    urgency: 'Moderate',
    timeWindow: 'Before sleep and during monthly household reset.',
    decisionRule: 'Every sleeping area needs a working alarm path that can wake the people inside.',
    quickAnswer: 'Put working smoke alarms on every level and inside or near sleeping areas, test them on schedule, and pair them with a practiced escape route and meeting point.',
    gear: ['Smoke alarms', 'Fresh batteries if required', 'Escape plan and meeting point'],
    doNow: [
      'Test each alarm and replace batteries or units according to label instructions.',
      'Confirm alarms are present where people sleep and that everyone recognizes the sound.',
      'Walk two ways out of each room and confirm the outside meeting point.',
    ],
    avoid: [
      'Do not remove batteries for nuisance alarms without fixing the cause.',
      'Do not assume one alarm in a hallway protects every room.',
      'Do not delay escape-plan practice until after a fire.',
    ],
    escalateIf: [
      'A person cannot wake to the alarm or needs assistance evacuating.',
      'The building has locked, blocked, painted-shut, or barred exits.',
      'You cannot install, replace, or test alarms yourself.',
    ],
    sourceAnchors: ['Ready.gov home fire escape plan', 'NFPA smoke alarm guidance', 'Local fire department'],
  },
]
...
export const instituteResearchSources = [
  ...
  {
    label: 'National Weather Service safety guidance',
    url: 'https://www.weather.gov/safety/',
    note: 'Used for severe weather, flood, tornado, winter travel, heat, and alert-response guardrails.',
  },
  {
    label: 'Poison Help and America’s Poison Centers',
    url: 'https://www.poisonhelp.org/',
    note: 'Used for poison-exposure escalation, plant-ingestion uncertainty, and the national Poison Help pathway.',
  },
  {
    label: 'American Red Cross first-aid guidance',
    url: 'https://www.redcross.org/take-a-class/resources/learn-first-aid',
    note: 'Used for bleeding-control, first-aid escalation, hypothermia, and household emergency training boundaries.',
  },
  {
    label: 'NFPA home fire safety guidance',
    url: 'https://www.nfpa.org/education-and-research/home-fire-safety',
    note: 'Used for home fire escape, smoke alarms, cooking fires, and household fire-prevention behaviors.',
  },
  {
    label: 'FDA food-safety emergency guidance',
    url: 'https://www.fda.gov/food/food-safety-during-emergencies',
    note: 'Used for power-outage food handling, refrigerator and freezer temperature thresholds, and flood-exposed food decisions.',
  },
  {
    label: 'EPA emergency drinking-water guidance',
    url: 'https://www.epa.gov/ground-water-and-drinking-water/emergency-disinfection-drinking-water',
    note: 'Used for drinking-water disinfection, boiling, filtering, and contaminated-water limits.',
  }
]
