...
const chapter: Chapter = {
  ...
  content: [
    ...
    { type: 'image', image: { src: '/chapters/heroes/overview.jpg', alt: 'Television broadcasting studio — representative of the media infrastructure controlled by six corporations', caption: 'A television broadcasting studio. In 1983, fifty companies controlled the majority of American media. By 2025, that number collapsed to six — all sharing the same institutional investors.', credit: 'Editorial illustration · Veritas Worldwide' } },
