...
export const PACK_CAROUSELS: PackCarousel[] = [
  {
    ...
    slides: [
      ...
      { headline: 'Primary Sources Only', body: 'We didn\'t ask pundits what they think. We read the FOMC statement, the dot plot, and the BLS data. Then we showed you.', source: 'Veritas Worldwide', bgStyle: 'light' },
      { headline: 'Read the Full Analysis', body: 'Every figure sourced. Every claim linked to the original document.\n\nveritasworldwide.com', source: 'Veritas Worldwide', bgStyle: 'crimson' },
    ],
  },
  {
    ...
    slides: [
      ...
      { headline: 'No Commentary Needed', body: 'We don\'t tell you what to think. We show you the documents. The primary sources. The public record. Read it yourself.', source: 'Veritas Worldwide', bgStyle: 'crimson' },
      { headline: 'Read the Full Breakdown', body: 'Every document sourced. Every claim verified against the original filing.\n\nveritasworldwide.com', source: 'Veritas Worldwide', bgStyle: 'dark' },
    ],
  },
  {
    packId: 'fisa-702',
  ...
  },
  {
    ...
    slides: [
      ...
      { headline: 'Follow the Money', body: 'We traced every dollar through FEC filings. Named donors. Shell PAC structures. Recipient lists. No opinion — just the documented money trail.', source: 'Veritas Worldwide', bgStyle: 'dark' },
  ...
  },
  {
    ...
    slides: [
      { headline: 'We Don\'t Tell You What to Think', body: 'Veritas Worldwide is different. We cite exclusively primary sources. No anonymous sources. No opinion. No spin.', source: 'Veritas Worldwide', bgStyle: 'dark' },
      ...
      { headline: 'Your Conclusions', body: 'We present the evidence. We cite the sources. We classify the claims. You decide what it means. That\'s how journalism should work.', source: 'Veritas Worldwide', bgStyle: 'dark' },
