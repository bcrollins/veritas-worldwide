...
export const ISRAEL_DOSSIER_VISUAL_INVESTIGATIONS: DossierDocumentedIncident[] = [
  ...
  {
    id: 'vi-gaza-blacksmith-shop-strike-visual-2023-2025',
    title: 'Gaza Civilian Blacksmith Shop Strike Visual Record — Multi-Outlet Packages',
    date: '2023–2025', location: 'Gaza Strip blacksmith shop strike areas',
    summary: 'Multi-outlet video and photo packages document damage affecting civilian blacksmith shop used by families including children. Multi-source visual floor; ethnicity is never evidence.',
    evidence: 'OCHA materials, multi-outlet visual packages, and OHCHR civilian-protection materials establish multi-source documentation of blacksmith shop strike damage affecting civilians.',
    sources: [
      { label: 'OCHA OPT humanitarian updates', url: 'https://www.ochaopt.org/' },
      { label: 'OHCHR civilian-protection materials', url: 'https://www.ohchr.org/' },
      { label: 'AP / Reuters Gaza packages', url: 'https://apnews.com/hub/israel-hamas-war' },
