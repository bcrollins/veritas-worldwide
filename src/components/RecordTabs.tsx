 ...
 * Tabs: Chapters | Israel Dossier | Deep State | Timeline | Content Packs & Brand Kit | AIPAC
 * Collapsible on desktop, horizontal bottom tabs on mobile.
 */
import { useState, type ReactNode } from 'react'

export type RecordTab = 'chapters' | 'israel' | 'deepstate' | 'timeline' | 'content' | 'aipac'
