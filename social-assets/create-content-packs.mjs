...
await p1.writeFile({ fileName: "social-assets/pack-federal-reserve-carousel.pptx" });
...
await p2.writeFile({ fileName: "social-assets/pack-epstein-files-carousel.pptx" });
...
await p3.writeFile({ fileName: "social-assets/pack-surveillance-carousel.pptx" });
...
await p4.writeFile({ fileName: "social-assets/pack-defense-budget-carousel.pptx" });
...
await p5.writeFile({ fileName: "social-assets/pack-aipac-carousel.pptx" });
